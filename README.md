...
2021 is when I began learning coding, first via SheCodes.io (web dev, JS/HTML/CSS), then Coding Dojo (graduated December 2021) for programming and building with React, Python, and Java. Through 2022, I continued upskilling with Udemy (Angela Yu) and FreeCodeCamp for JavaScript and React while working briefly as an email developer. In early 2023, I was approached by a recruiter from TEKSystems for a role with Takeda Pharmaceuticals in Exton, PA. I worked at Takeda from summer of 2023 until summer of 2024 as an IT Automation Engineer. 
